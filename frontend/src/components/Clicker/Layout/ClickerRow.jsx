...
const ClickerRow = ({clicker, editClicker, editClickerId,  onEdit, onDelete, onRestore, onSaveEdit, onCancelEdit, onEditChange, onToggle}) => {
    ...
    return(
        <TableRow className={`hover:bg-white ${clicker.status === "damaged" || clicker.status === "retired" ? "bg-red-50 hover:bg-red-50 text-gray-500" : isEditing ? "bg-blue-50 hover:bg-blue-100" : ""}`}>
