    ...
    return (
        <DashboardContentDetailCard cols={4}>
            <DashboardDetailCard
                ...
                tooltipLabel={t("teacher.quizSessions.analytics.participantsTooltip")}
            />
            <DashboardDetailCard
                icon={icons.accuracy}
                ...
                tooltipLabel={t("teacher.quizSessions.analytics.accuracyTooltip")}
            />
            <DashboardDetailCard
                ...
                tooltipLabel={t("teacher.quizSessions.analytics.averageTimeTooltip")}
            />
            <DashboardDetailCard
                icon={icons.sessions}
                ...
                tooltipLabel={t("teacher.quizSessions.analytics.totalSessionsTooltip")}
            />
        </DashboardContentDetailCard>
    );
}
